...
fun FeatureLockedScreen(
    module: com.arktools.xiao.domain.engine.GameModule,
    campusLevel: Int,
    modifier: Modifier = Modifier
) {
    val requiredName = com.arktools.xiao.domain.engine.GameBalanceConfig.getSchoolLevelName(module.unlockLevel)
    EmptyState(
        icon = Icons.Default.School,
