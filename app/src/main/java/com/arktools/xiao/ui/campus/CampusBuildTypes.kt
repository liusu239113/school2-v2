...
object CampusBuildTypes {
    ...
    val FACILITY_SPECS = listOf(
        ...
        Spec("F_CLINIC", "医务室", 2, 2, 32.0, 1, R.drawable.bld_hospital, facility = FacilityType.CLINIC, buildDays = 18, downstream = "学生生活健康投诉必须先建这栋"),
        Spec("F_COUNSELING", "心理辅导站", 2, 2, 28.0, 1, R.drawable.bld_employment, facility = FacilityType.COUNSELING, buildDays = 16, downstream = "心理投诉必须先建这栋再开辅导"),
