package com.arktools.xiao.ui.main
...
import com.arktools.xiao.ui.gameover.CrisisDialog
import com.arktools.xiao.ui.gameover.GameOverScreen
import com.arktools.xiao.ui.gameover.GameOverViewModel
...
import com.arktools.xiao.ui.tutorial.TutorialOverlay
import com.arktools.xiao.ui.tutorial.TutorialManager
import com.arktools.xiao.ui.tutorial.CompletionCondition
...
import com.arktools.xiao.ui.menu.MainMenuScreen
import com.arktools.xiao.ui.menu.MenuViewModel
...
import com.arktools.xiao.ui.components.AdLoadingOverlay
import com.arktools.xiao.ui.components.FeatureLockedScreen
...
fun MainScreen(
    ...
    LaunchedEffect(privacyAccepted) {
        if (privacyAccepted == true) {
            ...
            com.arktools.xiao.TapSdkInitializer.ensureInitialized(context)
    ...
    val hasDorm = school?.facilities?.any {
        it.type == com.arktools.xiao.domain.model.FacilityType.DORMITORY
    } == true
    ...
    if (showExitDialog) {
        ...
        com.arktools.xiao.ui.components.PixelAlertDialog(
            ...
            confirmStyle = com.arktools.xiao.ui.components.PixelButtonStyle.DANGER,
            dismissStyle = com.arktools.xiao.ui.components.PixelButtonStyle.SECONDARY
        )
    }
