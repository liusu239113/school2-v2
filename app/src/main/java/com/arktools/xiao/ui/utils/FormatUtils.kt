package com.arktools.xiao.ui.utils
...
object FormatUtils {
     ...
     */
    fun formatTeacherLevel(level: com.arktools.xiao.domain.model.TeacherLevel): String {
        return when (level) {
            com.arktools.xiao.domain.model.TeacherLevel.C -> "C级 (初级)"
            com.arktools.xiao.domain.model.TeacherLevel.B -> "B级 (中级)"
            com.arktools.xiao.domain.model.TeacherLevel.A -> "A级 (高级)"
            com.arktools.xiao.domain.model.TeacherLevel.S -> "S级 (顶尖)"
        }
    }
}
