...
object UniversityAcademicCatalog {
    ...
    fun preferredIndustries(courseId: String): List<IndustryPreference> {
        ...
        return when (major ?: return defaultIndustries(track)) {
            UniversityMajor.CHINESE_LIT, UniversityMajor.HISTORY, UniversityMajor.PHILOSOPHY ->
                listOf(
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.EDUCATION, 4),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.MEDIA, 3),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.GOVERNMENT, 2),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.LAW, 1)
                )
            UniversityMajor.MATHEMATICS, UniversityMajor.PHYSICS, UniversityMajor.CHEMISTRY ->
                listOf(
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.RESEARCH, 4),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.EDUCATION, 3),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.TECHNOLOGY, 2),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.HEALTHCARE, 1)
                )
            UniversityMajor.COMPUTER ->
                listOf(
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.TECHNOLOGY, 5),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.FINANCE, 2),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.RESEARCH, 1)
                )
            UniversityMajor.MECHANICAL, UniversityMajor.CIVIL ->
                listOf(
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.ENGINEERING, 5),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.COMMERCE, 2),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.GOVERNMENT, 1)
                )
            UniversityMajor.FINANCE ->
                listOf(
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.FINANCE, 5),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.COMMERCE, 2),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.GOVERNMENT, 1)
                )
            UniversityMajor.MANAGEMENT, UniversityMajor.MARKETING ->
                listOf(
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.COMMERCE, 4),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.MEDIA, 2),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.FINANCE, 2)
                )
            UniversityMajor.FINE_ARTS, UniversityMajor.MUSIC_PERFORMANCE ->
                listOf(
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.MEDIA, 4),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.EDUCATION, 3),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.COMMERCE, 1)
                )
            UniversityMajor.VISUAL_DESIGN ->
                listOf(
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.TECHNOLOGY, 3),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.MEDIA, 3),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.COMMERCE, 2)
                )
            UniversityMajor.CLINICAL, UniversityMajor.NURSING, UniversityMajor.PHARMACY ->
                listOf(
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.HEALTHCARE, 5),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.RESEARCH, 2),
                    IndustryPreference(com.arktools.xiao.domain.employment.Industry.EDUCATION, 1)
                )
        }
    }
    ...
    private fun defaultIndustries(track: AdmissionTrack?): List<IndustryPreference> {
        return when (track) {
            ...
            AdmissionTrack.SCIENCE -> listOf(
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.RESEARCH, 3),
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.EDUCATION, 2),
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.TECHNOLOGY, 2)
            )
            AdmissionTrack.ENGINEERING -> listOf(
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.ENGINEERING, 4),
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.TECHNOLOGY, 3)
            )
            AdmissionTrack.BUSINESS -> listOf(
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.FINANCE, 3),
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.COMMERCE, 3)
            )
            ...
            AdmissionTrack.MEDICINE -> listOf(
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.HEALTHCARE, 4),
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.RESEARCH, 2)
            )
            null -> listOf(
                IndustryPreference(com.arktools.xiao.domain.employment.Industry.COMMERCE, 2),
    ...
    fun pickIndustry(courseId: String, random: Random): com.arktools.xiao.domain.employment.Industry {
    ...
    fun pickIndustry(courseId: String, random: java.util.Random): com.arktools.xiao.domain.employment.Industry {
        val prefs = preferredIndustries(courseId)
        val total = prefs.sumOf { it.weight }
        var roll = random.nextInt(total.coerceAtLeast(1))
        prefs.forEach { pref ->
    ...
    fun pickIndustryDeterministic(courseId: String, index: Int): com.arktools.xiao.domain.employment.Industry {
        val prefs = preferredIndustries(courseId)
        val weighted = prefs.flatMap { pref -> List(pref.weight) { pref.industry } }
        if (weighted.isEmpty()) return com.arktools.xiao.domain.employment.Industry.COMMERCE
...
data class IndustryPreference(
    val industry: com.arktools.xiao.domain.employment.Industry,
    val weight: Int
)
