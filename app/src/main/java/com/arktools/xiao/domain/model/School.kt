...
data class School(
    ...
    var tierKey: String = com.arktools.xiao.domain.model.SchoolTier.APPLIED.key,       // 办学层次（专科/本科）
    var ownershipKey: String = com.arktools.xiao.domain.model.SchoolOwnership.PRIVATE.key, // 办学性质（公办/民办）
    var promotionHistoryJson: String = "",  // 升格史（SchoolPromotionRecord 列表）
    var cash: Double = com.arktools.xiao.domain.engine.GameBalanceConfig.INITIAL_CASH,
    var marketCap: Double = 100.0,
    var reputation: Long = com.arktools.xiao.domain.engine.GameBalanceConfig.INITIAL_REPUTATION,
    var starRating: Float = 0f,
    val foundedYear: Int = com.arktools.xiao.domain.engine.GameBalanceConfig.STARTING_YEAR,
    var currentYear: Int = com.arktools.xiao.domain.engine.GameBalanceConfig.STARTING_YEAR,
    var currentMonth: Int = 8,  // 8月建校，9月开学招生
    var currentDay: Int = 1,
    var campusLevel: Int = com.arktools.xiao.domain.engine.GameBalanceConfig.INITIAL_CAMPUS_LEVEL,
    var levelUpYear: Int = com.arktools.xiao.domain.engine.GameBalanceConfig.STARTING_YEAR, // 上次升级的年份（计算在当前等级的运营年数）
    var maxTeachers: Int = com.arktools.xiao.domain.engine.GameBalanceConfig.INITIAL_MAX_TEACHERS,
    ...
    var lastYearEndProcessingYear: Int =
        com.arktools.xiao.domain.engine.GameBalanceConfig.STARTING_YEAR,
