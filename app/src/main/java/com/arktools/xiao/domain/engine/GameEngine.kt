...
import com.arktools.xiao.domain.model.schoolOwnership
import com.arktools.xiao.domain.model.schoolTier
import com.arktools.xiao.domain.model.promotionHistory
...
import com.arktools.xiao.domain.model.ActivityAction
import com.arktools.xiao.domain.model.ClubAction
import com.arktools.xiao.domain.model.EventChoice
import com.arktools.xiao.domain.model.EventConsequence
import com.arktools.xiao.domain.model.TeacherAction
...
import com.arktools.xiao.domain.model.TeacherState
import com.arktools.xiao.domain.model.TeacherTrait
...
import com.arktools.xiao.domain.model.StudentNameGenerator
import com.arktools.xiao.domain.model.StudentProgressCalculator
import com.arktools.xiao.domain.model.StudentSatisfactionCalculator
import com.arktools.xiao.domain.model.StudentStatus
import com.arktools.xiao.domain.model.StudentTraitAssigner
...
import com.arktools.xiao.domain.model.ClassStrategy
import com.arktools.xiao.domain.model.ClassEvent
...
import com.arktools.xiao.domain.policy.EnrollmentPlan
...
class GameEngine @Inject constructor(
    ...
    private val achievementManager: com.arktools.xiao.domain.achievement.AchievementManager,
    private val milestoneManager: com.arktools.xiao.domain.milestone.MilestoneManager,
    private val competitorEngine: com.arktools.xiao.domain.competitor.CompetitorEngine,
    val gameOverDetector: GameOverDetector,
    private val notificationManager: com.arktools.xiao.domain.notification.NotificationManager,
    val alumniNetwork: com.arktools.xiao.domain.alumni.AlumniNetwork,
    val policyManager: com.arktools.xiao.domain.policy.SchoolPolicyManager,
    val clubManager: com.arktools.xiao.domain.club.ClubManager,
    val seasonalActivityManager: com.arktools.xiao.domain.seasonal.SeasonalActivityManager,
    val employmentMarket: com.arktools.xiao.domain.employment.EmploymentMarket,
    val reputationManager: com.arktools.xiao.domain.reputation.ReputationManager,
    val studentLifeManager: com.arktools.xiao.domain.studentlife.StudentLifeManager,
    val campusExpansionManager: com.arktools.xiao.domain.expansion.CampusExpansionManager,
    val partnerCommissionManager: com.arktools.xiao.domain.partner.PartnerCommissionManager,
    val academicConferenceManager: com.arktools.xiao.domain.conference.AcademicConferenceManager,
    val clubActivityManager: com.arktools.xiao.domain.clubactivity.ClubActivityManager,
    val teacherDevelopmentManager: com.arktools.xiao.domain.teacherdev.TeacherDevelopmentManager,
    val financialReportManager: com.arktools.xiao.domain.finance.FinancialReportManager,
    ...
    val timetableManager: com.arktools.xiao.domain.timetable.TimetableManager,
    val examManager: com.arktools.xiao.domain.exam.ExamManager,
    ...
    private fun teacherTitleToLevel(
        title: com.arktools.xiao.domain.teacherdev.TeacherTitle
    ): com.arktools.xiao.domain.model.TeacherLevel {
        return when (title) {
            com.arktools.xiao.domain.teacherdev.TeacherTitle.PROBATION,
            com.arktools.xiao.domain.teacherdev.TeacherTitle.JUNIOR ->
                com.arktools.xiao.domain.model.TeacherLevel.C
            com.arktools.xiao.domain.teacherdev.TeacherTitle.INTERMEDIATE ->
                com.arktools.xiao.domain.model.TeacherLevel.B
            com.arktools.xiao.domain.teacherdev.TeacherTitle.SENIOR ->
                com.arktools.xiao.domain.model.TeacherLevel.A
            com.arktools.xiao.domain.teacherdev.TeacherTitle.MASTER,
            com.arktools.xiao.domain.teacherdev.TeacherTitle.DISTINGUISHED ->
                com.arktools.xiao.domain.model.TeacherLevel.S
        }
    }

    private fun isPrimarilyTeaching(teacher: Teacher): Boolean {
        return teacher.role.category in listOf(
            com.arktools.xiao.domain.model.SubjectCategory.LITERATURE,
            com.arktools.xiao.domain.model.SubjectCategory.SCIENCE,
            com.arktools.xiao.domain.model.SubjectCategory.LANGUAGE
        )
    }
    ...
    suspend fun foundCollege(
        type: com.arktools.xiao.domain.policy.CollegeType,
        buildDays: Int = 1,
        buildingKey: String,
    ...
    suspend fun registerUniversityCompetition(
        ...
        tier: com.arktools.xiao.domain.competition.UniversityCompetitionManager.CompetitionTier
     ...
     * 提升该学院学生掌握度成长与毕业表现。
     */
    suspend fun openCoreCourse(college: com.arktools.xiao.domain.policy.CollegeType): ManagedOperationResult =
        engineOperationMutex.withLock {
            if (!managerStatesReadyForSave || "policyJson" in managerRestoreFailedFields) {
                return@withLock ManagedOperationResult(false, "政策状态尚未安全恢复，请稍后重试")
            }
    ...
    suspend fun launchGraduateProgram(): ManagedOperationResult =
        engineOperationMutex.withLock {
            ...
            val eligible = listOf(
                com.arktools.xiao.domain.policy.CollegeType.SCIENCE,
                com.arktools.xiao.domain.policy.CollegeType.ENGINEERING,
                com.arktools.xiao.domain.policy.CollegeType.MEDICINE
    ...
    suspend fun executePromotionApproval(
        action: com.arktools.xiao.domain.model.PromotionAction
    ) {
        if (action.decline) {
        ...
        val promoted = schoolRepository.mutateSchool { latest ->
            ...
            if (current.promotionTargetKey == action.targetTierKey) {
                ...
                val record = com.arktools.xiao.domain.model.SchoolPromotionRecord(
                ...
                latest.promotionHistoryJson = kotlinx.serialization.json.Json.encodeToString(
                    kotlinx.serialization.serializer<List<com.arktools.xiao.domain.model.SchoolPromotionRecord>>(),
                    history + record
                )
        ...
        emitEvent(GameEvent.MilestoneEvent(
            ...
            milestoneType = com.arktools.xiao.domain.model.MilestoneType.MARKET_CAP_MILESTONE
        ), school)
    }
    ...
    suspend fun acceptPartnerCommission(id: String): ManagedOperationResult =
        engineOperationMutex.withLock {
            ...
            val commission = partnerCommissionManager.state.value.offers
                .firstOrNull { it.id == id && it.status == com.arktools.xiao.domain.partner.CommissionStatus.OFFERED }
                ?: return@withLock ManagedOperationResult(false, "该委托已失效或被接走")
            if (partnerCommissionManager.state.value.active.size >=
                com.arktools.xiao.domain.partner.PartnerCommissionManager.MAX_ACTIVE
            ) {
            ...
            val blocked = partnerCommissionManager.canAccept(
                ...
                runCatching {
                    com.arktools.xiao.domain.model.FacilityType.valueOf(typeName)
                }.getOrNull()?.let { ft ->
    ...
    suspend fun startAcademicConference(
        type: com.arktools.xiao.domain.conference.ConferenceType,
        role: com.arktools.xiao.domain.conference.ConferenceRole,
        field: com.arktools.xiao.domain.conference.AcademicField
    ): ManagedOperationResult = engineOperationMutex.withLock {
    ...
    suspend fun startTeacherDevelopmentTraining(
        teacherId: String,
        program: com.arktools.xiao.domain.teacherdev.TrainingProgram
    ): ManagedOperationResult = engineOperationMutex.withLock {
    ...
    suspend fun promoteTeacherDevelopment(
        teacherId: String
    ): com.arktools.xiao.domain.teacherdev.PromotionResult =
        engineOperationMutex.withLock {
            val failure =
                com.arktools.xiao.domain.teacherdev.PromotionResult.PERSISTENCE_FAILED
            val (result, persisted) = commitTeacherDevelopmentOperationLocked(
                failure
            ) {
                val teacher = teacherRepository.getTeacherById(teacherId)
                if (teacher == null || !teacher.isWorking) {
                    TeacherDevelopmentCommit(
                        com.arktools.xiao.domain.teacherdev.PromotionResult.NOT_FOUND,
                        false
                    )
                } else {
                    val promotion = teacherDevelopmentManager.tryPromote(teacherId)
                    if (promotion !=
                        com.arktools.xiao.domain.teacherdev.PromotionResult.SUCCESS
                    ) {
    ...
    suspend fun evaluateTeacherDevelopment(
        teacherId: String
    ): com.arktools.xiao.domain.teacherdev.EvaluationResult? =
        engineOperationMutex.withLock {
            val (result, persisted) = commitTeacherDevelopmentOperationLocked<
                com.arktools.xiao.domain.teacherdev.EvaluationResult?
            >(null) {
    ...
    suspend fun startCampusConstruction(
        type: com.arktools.xiao.domain.expansion.CampusZoneType,
        name: String,
        quality: Int
    ): ManagedOperationResult = engineOperationMutex.withLock {
        ...
        val school = schoolRepository.getSchool()
            ?: return@withLock ManagedOperationResult(false, "学校数据尚未就绪")
        val blocked = com.arktools.xiao.domain.expansion.CampusExpansionManager
    ...
    suspend fun upgradeCampusExpansionLevel(): ManagedOperationResult =
        engineOperationMutex.withLock {
            commitExpansionOperationLocked { school ->
                ...
                val currentIndex =
                    com.arktools.xiao.domain.expansion.CampusLevel.entries
                        .indexOf(state.currentLevel)
                if (currentIndex >=
                    com.arktools.xiao.domain.expansion.CampusLevel.entries.size - 1
                ) {
    ...
    val miniGameTrigger: SharedFlow<com.arktools.xiao.domain.seasonal.SeasonalActivity> = _miniGameTrigger.asSharedFlow()
     ...
     */
    fun applyFactionEventChoice(action: com.arktools.xiao.domain.model.FactionChoiceAction): Boolean {
        ...
        when (event) {
            is GameEvent.PositiveEvent -> {
                if (event.bonusCash > 50 || event.bonusReputation > 3 || event.title.contains("毕业") || event.title.contains("灵感")) {
                    val posType = when {
                        event.title.contains("毕业") || event.title.contains("学位授予") || event.title.contains("研究生") -> com.arktools.xiao.domain.model.NotificationType.STUDENT
                        event.title.contains("灵感") -> com.arktools.xiao.domain.model.NotificationType.TEACHER
            ...
            is GameEvent.NegativeEvent -> {
                val type = when {
                    ...
                    event.title.contains("下降") || event.title.contains("下跌") -> com.arktools.xiao.domain.model.NotificationType.MARKET
                    else -> com.arktools.xiao.domain.model.NotificationType.FINANCIAL
                }
                val priority = when {
                    event.title.contains("危机") -> com.arktools.xiao.domain.model.NotificationPriority.URGENT
    ...
    private fun campusTileEffects(raw: String): CampusTileEffects {
        ...
        return runCatching {
            val tiles = kotlinx.serialization.json.Json { ignoreUnknownKeys = true }
                .decodeFromString<List<com.arktools.xiao.ui.campus.CampusBuildTypes.TerrainCell>>(raw)
            var maintenance = 0.0
            var reputation = 0L
            var satisfaction = 0f
            tiles.forEach { cell ->
                val kind = com.arktools.xiao.ui.campus.CampusBuildTypes.TileKind.entries
    ...
    suspend fun retriggerActivityApproval(activityId: String) {
        ...
        if (activity.phase != com.arktools.xiao.domain.seasonal.ActivityPhase.PENDING_APPROVAL) return
        ...
        historicalSummaryYears.forEach { (year, cohort) ->
            ...
            alumniNetwork.recordGraduationBatch(
                ...
                topStudents = cohort.sortedByDescending { it.gaoKaoScore }
                    .take(5)
                    .map { student ->
                        com.arktools.xiao.domain.alumni.GraduationTopStudent(
                            name = student.name,
    ...
    private class MonthlySettlementState {
        ...
        lateinit var employmentResult: com.arktools.xiao.domain.employment.EmploymentMonthlyResult
    ...
    private suspend fun msStage1(school: School, st: MonthlySettlementState) {
            ...
            val alumniResult = if (
                ...
                com.arktools.xiao.domain.alumni.AlumniMonthlyResult()
            }
            ...
            alumniResult.events.forEach { alumniEvent ->
                when (alumniEvent) {
                    is com.arktools.xiao.domain.alumni.AlumniEvent.MajorDonation -> {
                        deferEvent(GameEvent.PositiveEvent(
                            title = "校友巨额捐赠",
                    ...
                    is com.arktools.xiao.domain.alumni.AlumniEvent.CampusSpeech -> {
                        deferEvent(GameEvent.PositiveEvent(
                            title = "校友返校演讲",
                    ...
                    is com.arktools.xiao.domain.alumni.AlumniEvent.Donation -> {}
                    is com.arktools.xiao.domain.alumni.AlumniEvent.Referral -> {}
                }
            }
            ...
            if (totalStudents > 0 &&
                ...
                clubResult.events.forEach { clubEvent ->
                    when (clubEvent) {
                        is com.arktools.xiao.domain.club.ClubEvent.Competition -> {
                            if (clubEvent.won) {
                                deferEvent(GameEvent.PositiveEvent(
                                    title = "社团竞赛获奖",
                        ...
                        is com.arktools.xiao.domain.club.ClubEvent.Achievement -> {
                            deferEvent(GameEvent.PositiveEvent(
                                title = "社团成就",
            ...
            val govBoostForEmployment = governmentInspectionManager.state.value.let { govState ->
                when (govState.currentGrade) {
                    com.arktools.xiao.domain.government.SchoolGrade.AAA -> 1.30f
                    com.arktools.xiao.domain.government.SchoolGrade.AA -> 1.15f
                    com.arktools.xiao.domain.government.SchoolGrade.A -> 1.05f
                    else -> 1.0f
                }
            }
            // 学术会议对就业的累积加成
            ...
            st.employmentResult.events.forEach { empEvent ->
                when (empEvent) {
                    is com.arktools.xiao.domain.employment.EmploymentEvent.UniversityGraduation -> {
                        emitEvent(GameEvent.PositiveEvent(
                            title = "毕业生喜讯",
                    ...
                    is com.arktools.xiao.domain.employment.EmploymentEvent.AlumniSuccess -> {
                        emitEvent(GameEvent.PositiveEvent(
                            title = "校友成就",
    ...
    private suspend fun msStage2(school: School, st: MonthlySettlementState) {
            ...
            val sportsFieldLevel = school.facilities.find { it.type == com.arktools.xiao.domain.model.FacilityType.SPORTS_FIELD }?.level ?: 0
            val artStudioLevel = school.facilities.find { it.type == com.arktools.xiao.domain.model.FacilityType.ART_STUDIO }?.level ?: 0
            val sportsClubs = clubManager.clubs.value.filter { it.type.category == com.arktools.xiao.domain.club.ClubCategory.SPORTS }.size
            val artsClubs = clubManager.clubs.value.filter { it.type.category == com.arktools.xiao.domain.club.ClubCategory.ARTS }.size
            ...
            var committedExpansionResult:
                com.arktools.xiao.domain.expansion.ExpansionMonthlyResult? = null
            ...
            runCatching {
                ...
                val partnerContext = com.arktools.xiao.domain.partner.CompletionContext(
            ...
            val confResult = if (
                ...
                com.arktools.xiao.domain.conference.ConferenceMonthlyResult()
            }
            ...
            val teacherDevUnavailable =
                com.arktools.xiao.domain.teacherdev.TeacherDevMonthlyResult()
            val (teacherDevResult, teacherDevCommitted) =
                commitTeacherDevelopmentOperationLocked(teacherDevUnavailable) {
                    val teacherSyncData = workingTeachersForDevelopment.map { teacher ->
                        com.arktools.xiao.domain.teacherdev.TeacherSyncData(
                            id = teacher.id,
            ...
            teacherDevResult.departures.forEach { departure ->
                ...
                if (departure.reason == com.arktools.xiao.domain.teacherdev.TeacherDepartureReason.RETIRED) {
                    emitEvent(
                    ...
                    emitEvent(
                        GameEvent.NegativeEvent(
                            title = "教师离职: $display",
                            message = if (
                                departure.reason == com.arktools.xiao.domain.teacherdev.TeacherDepartureReason.POACHED
    ...
    private suspend fun msStage3(school: School, st: MonthlySettlementState) {
            ...
            if (st.studentCount > 0) {
                ...
                val parentResult = if (
                    ...
                    com.arktools.xiao.domain.parent.ParentMonthResult()
                }
            ...
            suggestionPenalties.forEach { penalty ->
                when (penalty.submitterType) {
                    com.arktools.xiao.domain.suggestion.SubmitterType.STUDENT -> {
                        studentRepository.adjustStudentSatisfaction(
                            penalty.submitterId,
                            -penalty.penaltyAmount
                        )
                    }
                    com.arktools.xiao.domain.suggestion.SubmitterType.TEACHER -> {
            ...
            val govResult = if (
                ...
                com.arktools.xiao.domain.government.GovernmentMonthResult()
            }
            ...
            runCatching {
                    ...
                    if (foundedNow.isNotEmpty()) {
                        ...
                        foundedNow.forEach { c ->
                            when (c) {
                                com.arktools.xiao.domain.policy.CollegeType.SCIENCE,
                                com.arktools.xiao.domain.policy.CollegeType.ENGINEERING,
                                com.arktools.xiao.domain.policy.CollegeType.MEDICINE -> academic += 1.5f
                                com.arktools.xiao.domain.policy.CollegeType.LIBERAL_ARTS -> {
                                    academic += 0.5f; social += 0.5f
                                }
                                com.arktools.xiao.domain.policy.CollegeType.BUSINESS -> social += 1.0f
                                com.arktools.xiao.domain.policy.CollegeType.ARTS -> arts += 1.5f
                            }
                        }
                ...
                if (collegeDev.founded.contains(
                    ...
                    val medStudents = st.cachedActiveStudentsForMonth.count { student ->
                        com.arktools.xiao.domain.model.UniversityAcademicCatalog
                            ...
                            com.arktools.xiao.domain.model.AdmissionTrack.MEDICINE
                    }
                ...
                val artsFounded = collegeDev.founded.contains(
                    com.arktools.xiao.domain.policy.CollegeType.ARTS
                )
            ...
            runCatching {
                ...
                if (founded.isNotEmpty()) {
                    val coverage = com.arktools.xiao.domain.model.UniversityAcademicCatalog
    ...
    private suspend fun msStage4(school: School, st: MonthlySettlementState) {
                        ...
                        choices = facEvent.choices.mapIndexed { index, choice ->
                            EventChoice(
                                ...
                                consequence = EventConsequence(
                                    ...
                                    factionChoiceAction = com.arktools.xiao.domain.model.FactionChoiceAction(
                                        eventId = facEvent.id,
                                        choiceIndex = index
                                    )
                                )
                ...
                deferEvent(GameEvent.ChoiceEvent(
                    ...
                    choices = listOf(
                        EventChoice("同意加薪", EventConsequence(
                            cashChange = 0.0,
                            teacherAction = com.arktools.xiao.domain.model.TeacherAction.ApproveRaise(req.teacherId, req.raisePercent)
                        )),
                        EventChoice("拒绝加薪", EventConsequence(
                            teacherAction = com.arktools.xiao.domain.model.TeacherAction.RejectRaise(req.teacherId)
                        ))
                    )
                ))
            }
                    ...
                    deferEvent(GameEvent.ChoiceEvent(
                        ...
                        choices = listOf(
                            ...
                            EventChoice(
                                ...
                                EventConsequence(
                                    reputationChange = -3,
                                    teacherAction = com.arktools.xiao.domain.model.TeacherAction.DeclineRenewal(
                                        renewal.teacherId
                                    )
                                )
                            )
            ...
            emitMonthlyPrincipalDecision(school, st, latestCash, netProfit)

    }

    private fun emitMonthlyPrincipalDecision(
        school: School,
        st: MonthlySettlementState,
        latestCash: Double,
        netProfit: Double
    ) {
        val students = st.cachedActiveStudentsForMonth.size
        ...
        val bedGap = (students - beds).coerceAtLeast(0)
        val mealGap = (students - seats).coerceAtLeast(0)
        val seatGap = (students - classroomSeats).coerceAtLeast(0)
        val (title, message, choices) = when {
            latestCash < 0 || netProfit < -8.0 -> Triple(
                "校长月度决策：保运转",
                "账上吃紧。这个月必须拍板：是砍专项保工资，还是硬撑口碑。不做决定，下月声誉和招生都会掉。",
                listOf(
                    EventChoice(
                        "砍掉一半专项活动，先把工资发出去",
                        EventConsequence(cashChange = 6.0, reputationChange = -40)
                    ),
                    EventChoice(
                        "对外解释困难，请家长再给学校一点时间",
                        EventConsequence(cashChange = 2.0, reputationChange = -20)
                    ),
                    EventChoice(
                        "继续硬撑，对外装作一切正常",
                        EventConsequence(cashChange = -4.0, reputationChange = 15)
                    )
                )
            )
            mealGap > 0 -> Triple(
                "校长月度决策：学生吃饭",
                "有 $mealGap 人挤食堂。窗口不够，月底已经有投诉。这个月必须处理吃饭问题。",
                listOf(
                    EventChoice(
                        "加开窗口并补贴热菜",
                        EventConsequence(cashChange = -5.0, reputationChange = 50)
                    ),
                    EventChoice(
                        "错峰放学，让一半学生晚去食堂",
                        EventConsequence(cashChange = -1.0, reputationChange = 10)
                    ),
                    EventChoice(
                        "先顶着，等有钱再建食堂",
            ...
            bedGap > 0 -> Triple(
                "校长月度决策：床位",
                "宿舍缺 $bedGap 张床。不住下的学生下季不会来报到。",
                listOf(
                    EventChoice(
                        "腾教室改临时宿舍",
                        EventConsequence(cashChange = -3.0, reputationChange = -10)
                    ),
                    EventChoice(
                        "联系校外公寓过渡",
                        EventConsequence(cashChange = -6.0, reputationChange = 30)
                    ),
                    EventChoice(
                        "让学生自己想办法",
            ...
            seatGap > 0 || classroomSeats <= students -> Triple(
                "校长月度决策：教室学位",
                "教室学位已经顶满。9月想再招人，这个月必须决定是挤一挤还是停招。",
                listOf(
                    EventChoice(
                        "大班授课，先把人塞进去",
                        EventConsequence(cashChange = -2.0, reputationChange = -25)
                    ),
                    EventChoice(
                        "公开说明学位已满，控制招生",
                        EventConsequence(reputationChange = 20)
                    ),
                    EventChoice(
                        "不管，继续按报名人数收",
                ...
                "校长月度决策：下月重心",
                "账上还能转。这个月选一个重心，选完立刻见账，不做等于默认混日子。",
                listOf(
                    EventChoice(
                        "把精力放在招生宣传上",
                        EventConsequence(cashChange = -3.0, reputationChange = 70)
                    ),
                    EventChoice(
                        "把精力放在课堂和科研上",
                        EventConsequence(cashChange = -2.0, reputationChange = 40)
                    ),
                    EventChoice(
                        "把精力放在学生吃饭和住宿上",
                        EventConsequence(cashChange = -4.0, reputationChange = 35)
                    )
                )
            )
        }
        emitEvent(
            GameEvent.ChoiceEvent(title = title, message = message, choices = choices),
            school
        )
    }
    ...
    private suspend fun msStage5(school: School, st: MonthlySettlementState) {
            ...
            try {
                ...
                completedStages.forEach { completion ->
                    ...
                    emitEvent(com.arktools.xiao.domain.model.GameEvent.MilestoneEvent(
                        title = "里程碑达成",
                        ...
                        deferEvent(GameEvent.ChoiceEvent(
                            ...
                            choices = listOf(
                                EventChoice("签字申报", EventConsequence(
                                    promotionAction = com.arktools.xiao.domain.model.PromotionAction(
            ...
            if (school.currentMonth == 6 && !st.isRetrySettlement) {
                ...
                val facultyCoverage = com.arktools.xiao.domain.model.UniversityAcademicCatalog.facultyCoverage(
    ...
    private suspend fun updateCourseProgress(course: CourseProject, school: School) {
        ...
        val subjectDifficulty = com.arktools.xiao.domain.model.SubjectConfig.getProfile(course.subject).difficulty
                ...
                val resignationEvent = GameEvent.ChoiceEvent(
                    ...
                    choices = listOf(
                        EventChoice(
                            text = "批准离职（签字）",
                            consequence = EventConsequence(
                                teacherAction = com.arktools.xiao.domain.model.TeacherAction.ApproveResignation(teacher.id),
                                requiresSignature = true
                            )
                        ),
                        EventChoice(
    ...
    private suspend fun deductMonthlyExpenses(school: School): MonthlyExpenseBreakdown {
        ...
        val facilityMaintenance = school.facilities
            ...
            com.arktools.xiao.domain.model.FacilityCapacity.logisticsMaintenanceFactor(logisticsLevel)
    ...
    private suspend fun recordMonthlyStats(school: School, revenue: Double, expenses: Double) {
        ...
        com.arktools.xiao.domain.model.StatisticsManager.recordMonth(
            school = school,
     ...
     * 应用竞争对手事件对玩家的影响
     */
    private suspend fun applyCompetitorEventEffect(event: com.arktools.xiao.domain.competitor.CompetitorEvent) {
        when (event) {
            is com.arktools.xiao.domain.competitor.CompetitorEvent.PriceWar -> {
            ...
            is com.arktools.xiao.domain.competitor.CompetitorEvent.TalentPoaching -> {
                // 挖角：随机降低一名教师忠诚度
            ...
            is com.arktools.xiao.domain.competitor.CompetitorEvent.MarketExpansion -> {
                schoolRepository.mutateSchool { latest ->
                    latest.reputation -= 2L
                    true
                }
            }
            is com.arktools.xiao.domain.competitor.CompetitorEvent.CompetitorCollapse -> {
                schoolRepository.mutateSchool { latest ->
            ...
            is com.arktools.xiao.domain.competitor.CompetitorEvent.Partnership -> {
                schoolRepository.mutateSchool { latest ->
                    latest.reputation += event.reputationGain
                    true
                }
    ...
    suspend fun calculateCourseScore(course: CourseProject, school: School): Float {
        ...
        val subjectFacilityBonus = when (course.subject.category) {
            ...
            com.arktools.xiao.domain.model.SubjectCategory.ART -> facilityBonuses.artBonus
            else -> 0f
        }
    ...
    suspend fun calculateEnrollment(course: CourseProject, school: School, monthsSinceRelease: Int, traitEnrollmentMultiplier: Double = 1.0): Long {
        ...
        val subjectProfile = com.arktools.xiao.domain.model.SubjectConfig.getProfile(course.subject)
    ...
    private fun getMarketTrend(subject: com.arktools.xiao.domain.model.Subject, theme: com.arktools.xiao.domain.model.CourseTheme, year: Int): Float {
        return GameBalanceConfig.getMarketTrend(subject, theme, year)
    }

    private fun getDistrictSubjectFit(district: com.arktools.xiao.domain.model.DistrictType, subject: com.arktools.xiao.domain.model.Subject): Float {
        return when (district) {
            com.arktools.xiao.domain.model.DistrictType.LOCAL -> 1.0f
            com.arktools.xiao.domain.model.DistrictType.CROSS_DISTRICT -> 0.9f
            com.arktools.xiao.domain.model.DistrictType.INTERNATIONAL ->
                if (subject == com.arktools.xiao.domain.model.Subject.ENGLISH) 1.2f else 0.8f
            com.arktools.xiao.domain.model.DistrictType.ONLINE_PLATFORM -> 1.1f
            com.arktools.xiao.domain.model.DistrictType.ELITE_ALLIANCE -> 1.15f
            com.arktools.xiao.domain.model.DistrictType.GLOBAL_NETWORK -> 1.2f
        }
    }
    ...
    private suspend fun enrollNewStudents(school: School) {
        ...
        // 学科建设：建设度提高生源吸引力
        val disciplineStates = com.arktools.xiao.domain.model.DisciplineCatalog.decode(
        ...
        val disciplineEnrollMultiplier = 1f + openedDisciplines * 0.01f +
            disciplineStates.values.sumOf {
                com.arktools.xiao.domain.model.DisciplineCatalog.enrollBonus(it).toDouble()
            }.toFloat()
        ...
        repeat(enrollCount) {
            ...
            val assignedTraits = if (
                ...
                (baseTraits + listOf(
                    com.arktools.xiao.domain.model.StudentTrait.ARTISTIC,
                    com.arktools.xiao.domain.model.StudentTrait.ATHLETIC,
                    com.arktools.xiao.domain.model.StudentTrait.COMPETITIVE
                ).random()).distinct()
            } else {
                baseTraits
            }
            ...
            val track = com.arktools.xiao.domain.model.UniversityAcademicCatalog.pickFreshmanTrack(
        ...
        if (newStudents.isNotEmpty()) {
            ...
            val trackCounts = assignedStudents.groupingBy {
                com.arktools.xiao.domain.model.UniversityAcademicCatalog.parseTrack(it.courseId)?.displayName
                    ?: "通识"
            }.eachCount()
    ...
    private suspend fun processStudentYearEnd(
        ...
        if (shouldRunFullYearEnd) {
            ...
            promotedStudents.forEach { student ->
                ...
                val track = com.arktools.xiao.domain.model.UniversityAcademicCatalog.parseTrack(student.courseId)
                    ?: return@forEach
                if (com.arktools.xiao.domain.model.UniversityAcademicCatalog.parseMajor(student.courseId) != null) {
                    return@forEach
                }
                val major = com.arktools.xiao.domain.model.UniversityAcademicCatalog.pickMajor(
                    track = track,
                    attributes = student.attributes,
                    founded = founded
                )
            ...
            if (majorUpdates.isNotEmpty()) {
                ...
                if (emitNotifications) {
                    val byMajor = majorUpdates.values
                        .map { com.arktools.xiao.domain.model.UniversityAcademicCatalog.displayName(it) }
                        .groupingBy { it }
                        .eachCount()
    ...
    private suspend fun processMajorTransfers(promotedStudents: List<Student>, school: School) {
        ...
        candidates.forEach { student ->
            ...
            val currentMajor = com.arktools.xiao.domain.model.UniversityAcademicCatalog
                .parseMajor(student.courseId) ?: return@forEach
            val track = currentMajor.track
            if (!founded.contains(track.college)) return@forEach
            val currentAffinity = com.arktools.xiao.domain.model.UniversityAcademicCatalog
                .affinityScore(currentMajor, student.attributes)
            val best = com.arktools.xiao.domain.model.UniversityAcademicCatalog
                .majorsFor(track)
                .filter { it != currentMajor }
                .map { it to com.arktools.xiao.domain.model.UniversityAcademicCatalog
    ...
    private suspend fun conductGaoKao(school: School, graduatingStudentIds: Set<String>? = null) {
        ...
        grade3Students.forEach { student ->
            val matchedTeachers = com.arktools.xiao.domain.model.UniversityAcademicCatalog
                .matchingTeachers(student.courseId, allTeachers)
            ...
            val gradCollege = com.arktools.xiao.domain.model.UniversityAcademicCatalog
                .collegeOf(student.courseId)
            ...
            val tierBonus = when (classTier) {
                com.arktools.xiao.domain.model.ClassTier.ROCKET -> 1.05f   // 拔尖培养班额外+5%
                com.arktools.xiao.domain.model.ClassTier.KEY -> 1.03f      // 专业核心班额外+3%
                else -> 1.0f
            }
    ...
    private suspend fun processPendingGraduationProjections(
        school: School,
        scoreLines: com.arktools.xiao.domain.exam.AnnualScoreLines? = null,
        ...
        yearsToProcess.forEach { graduationYear ->
                ...
                try {
                    ...
                    val topStudents = graduationCohort
                        ...
                        .take(5)
                        .map { student ->
                            com.arktools.xiao.domain.alumni
                    ...
                    val commit = com.arktools.xiao.domain.repository
    ...
    private suspend fun emitCampusWeeklyBrief(school: School) {
        ...
        notificationManager.addNotification(
            ...
            priority = if (missing.isNotEmpty() || monthsLeft < 3.0) {
                ...
                com.arktools.xiao.domain.model.NotificationPriority.NORMAL
            },
            gameYear = school.currentYear,
            gameMonth = school.currentMonth,
            gameDay = school.currentDay,
    ...
    private suspend fun maybeRunDisciplineEvaluation(school: School) {
        ...
        val dev = policyManager.policies.value.collegeDevelopment
        val states = com.arktools.xiao.domain.model.DisciplineCatalog.decode(dev.disciplinesJson).toMutableMap()
        ...
        states.forEach { (id, st) ->
            ...
            val rating = com.arktools.xiao.domain.model.DisciplineCatalog.evaluate(
                st,
                school.currentDay + (id.hashCode() and 0x7)
            )
            val outcome = com.arktools.xiao.domain.model.DisciplineCatalog.outcomeOf(rating)
            rep += outcome.reputation
            grant += outcome.grantWan
            val name = com.arktools.xiao.domain.model.DisciplineCatalog.byId(id)?.name ?: id
        ...
        schoolRepository.mutateSchool { s ->
            ...
            s.cash += grant
            val updated = dev.copy(disciplinesJson = com.arktools.xiao.domain.model.DisciplineCatalog.encode(states))
    ...
    private suspend fun runGraduateSchoolMonth(school: School) {
        ...
        if (school.currentMonth == 9 && gm.state.value.lastIntakeYear != school.currentYear) {
            val dev = policyManager.policies.value.collegeDevelopment
            val states = com.arktools.xiao.domain.model.DisciplineCatalog.decode(dev.disciplinesJson)
            ...
            if (built.isNotEmpty()) {
                ...
                val mQuota = com.arktools.xiao.domain.graduate.GraduateSchoolManager
                    .masterQuota(school.campusLevel, ratedAB)
                val pQuota = com.arktools.xiao.domain.graduate.GraduateSchoolManager
                    .phdQuota(school.campusLevel, ratedAPlus)
                val rng = kotlin.random.Random
                val fresh = buildList {
                    repeat(mQuota) {
                        add(com.arktools.xiao.domain.graduate.GradStudent(
                            id = java.util.UUID.randomUUID().toString(),
                            name = com.arktools.xiao.domain.graduate.GraduateSchoolManager.randomName(rng),
                            type = "MASTER",
    ...
    private suspend fun runInternationalMonth(school: School) {
        ...
        if (school.currentMonth == 9 && im.state.value.lastIntakeYear != school.currentYear && school.campusLevel >= 5) {
            ...
            if (quota > 0) {
                ...
                val countries = im.state.value.signedPartnerIds
                    .mapNotNull { com.arktools.xiao.domain.international.InternationalProgramManager.byId(it)?.country }
                val fresh = (1..quota).map {
                    com.arktools.xiao.domain.international.IntlStudent(
                        id = java.util.UUID.randomUUID().toString(),
                        name = com.arktools.xiao.domain.international.InternationalProgramManager.randomForeignName(rng),
        ...
        val income = im.monthlyIncomeWan() *
            com.arktools.xiao.domain.model.FacilityCapacity.internationalIncomeMultiplier(intlCenterLevel)
