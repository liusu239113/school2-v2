...
enum class ClassTier(
    ...
    val purpose: String            // 点 + 开这个班实际干什么
) {
    ROCKET("拔尖培养班", 30, 0.5f, 1.4f, 5.0, 0.5,
        "少而精。点一次立刻加30个新生学位，成绩涨得最快，开办5万、月费0.5万。冲口碑用。"),
    KEY("专业核心班", 40, 0.35f, 1.2f, 3.0, 0.3,
        "专业主干。点一次立刻加40个新生学位，成绩×1.2，开办3万。大多数学校的主力班。"),
    NORMAL("通识教学班", 50, 0.25f, 1.0f, 1.0, 0.15,
        "便宜、学位最多。点一次立刻加50个新生学位。不开这个班，9月几乎招不满。"),
    ART("艺术方向班", 35, 0.3f, 0.8f, 4.0, 0.4,
        "走美术出口。点一次加35个学位，成绩倍率低，但艺考生源和就业会走这条线。"),
    MUSIC("音乐方向班", 35, 0.3f, 0.8f, 4.0, 0.4,
        "走音乐出口。点一次加35个学位，适合音乐特长，培养偏专业演出。"),
    SPORTS("体育方向班", 40, 0.3f, 0.7f, 2.0, 0.25,
        "走体育特招。点一次加40个学位，成绩涨得慢，体测和运动会加成高。")
}
