...
interface SchoolDao {
    ...
    fun getSchoolCoreFlow(): Flow<com.arktools.xiao.data.local.entity.SchoolCoreEntity?>
    ...
    suspend fun getSchoolCore(): com.arktools.xiao.data.local.entity.SchoolCoreEntity?
