...
import com.arktools.xiaozhang.domain.repository.GraduationProjectionCommit
    ...
    private fun StudentEntity.toDomain(): Student {
        return Student(
            ...
            universityTier = universityTier?.let {
                try { com.arktools.xiaozhang.domain.model.UniversityTier.valueOf(it) } catch (_: Exception) { null }
            },
