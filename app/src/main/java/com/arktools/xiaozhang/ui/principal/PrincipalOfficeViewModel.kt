...
import com.arktools.xiaozhang.domain.suggestion.SuggestionPenalty
    ...
    fun ignoreSuggestion(suggestionId: Int) {
        ...
        if (penalty != null) {
            _suggestionActionResult.value = "已忽略建议，${penalty.submitterName}的${
                if (penalty.submitterType == com.arktools.xiaozhang.domain.suggestion.SubmitterType.TEACHER) "忠诚度" else "满意度"
