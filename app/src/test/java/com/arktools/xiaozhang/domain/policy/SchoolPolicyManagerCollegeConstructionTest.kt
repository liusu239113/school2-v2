...
class SchoolPolicyManagerCollegeConstructionTest {
    ...
    private fun newManager(): SchoolPolicyManager = SchoolPolicyManager(
        com.arktools.xiaozhang.domain.competition.UniversityCompetitionManager(),
        com.arktools.xiaozhang.domain.research.ResearchChainManager(),
        com.arktools.xiaozhang.domain.teacherdev.TeacherStoryManager(),
        com.arktools.xiaozhang.domain.graduate.GraduateSchoolManager(),
        com.arktools.xiaozhang.domain.international.InternationalProgramManager()
    )
