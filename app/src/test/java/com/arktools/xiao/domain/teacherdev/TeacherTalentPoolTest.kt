...
import com.arktools.xiao.domain.alumni.CareerLevel
import com.arktools.xiao.domain.alumni.CareerPath
    ...
    private fun generator(level: TeacherLevel, count: Int): List<Teacher> =
        List(count) { index ->
            Teacher(
                ...
                name = "候选$index",
                level = level,
                role = com.arktools.xiao.domain.model.TeacherRole.MATH,
                teaching = 300,
                research = 300,
                management = 300,
                psychology = 300,
